...
# মোবাইল স্ক্রিনের ব্যাকগ্রাউন্ড কালার ডার্ক করার জন্য
...
class BPLManagerGame(BoxLayout):
    def __init__(self, **kwargs):
        ...
        # গেমের প্রাথমিক ভ্যারিয়েবলসমূহ
        self.budget = 120000000  # ১২ কোটি টাকা বাজেট
        self.my_team = []
        
        # ২০ জন প্লেয়ারের ডাটাবেজ
        ...
        # ওপরের ড্যাশবোর্ড (বাজেট ও স্কোয়াড কাউন্ট)
        ...
        # প্লেয়ার লিস্ট দেখার জন্য স্ক্রোল ভিউ
        ...
        # নিচের কন্ট্রোল বাটনসমূহ (ম্যাচ, মেডিকেল ও রিসেট)
    ...
    def open_medical_camp(self, instance):
        ...
        # র্যান্ডম একজন প্লেয়ারকে বুস্ট দেওয়া
